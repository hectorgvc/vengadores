# Referencias extendidas — contador

Estructuras completas de reportes movidas desde `04-Agentes/contador.md` para
mantener el agente liviano. El agente `contador` remite acá cuando hace falta
el detalle de un reporte específico.
