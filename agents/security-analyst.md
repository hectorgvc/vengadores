...
Keys de AI, spending caps, prompt injection, output no confiable y tool/function calling: ver referencia.

## Referencia extendida

Cuando necesites el detalle de vibe-coding patterns (AI keys, spending caps, prompt injection, tool calling), leé `~/ObsidianVault/04-Agentes/referencias/security-vibe-coding.md`.
